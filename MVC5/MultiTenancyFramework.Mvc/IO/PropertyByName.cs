...
namespace MultiTenancyFramework.IO
{
    ...
    /// <summary>
    /// A helper class to access the property by name for the column
    /// </summary>
    /// <typeparam name="T">Object type</typeparam>
    public class PropertyByName<T> : MyDataColumn<T>
    {
        ...
        public PropertyByName(Expression<Func<T, object>> func, bool ignore = false)
            : this(func, null)
        {
        }
        ...
        /// <param name="ignore">Specifies whether the property should be exported</param>
        public PropertyByName(Expression<Func<T, object>> func, string columnName, bool ignore = false)
            : base(func, columnName)
        {
            this.GetProperty = func.Compile();
